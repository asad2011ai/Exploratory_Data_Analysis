...
with(state, plot(Income,Illiteracy))
...
g <- ggplot(data = longley, aes(Unemployed, GNP))
g + geom_point() + labs(title = "GNP and Unemployed")
```

```{r }
# START YOUR CODE fFOR GRAPH-2
ggplot(longley, aes(GNP, Unemployed))+ geom_point(color = "blue")+labs(title = "GNP and Unemployed with Blue")
ggplot(longley, aes(GNP, Employed))+ geom_point(color = "Green")+labs(title = "GNP and Employed with Green")
...
longley$ARMUnemploy <- Armed.Forces.Unemployed.Rel

ggplot(longley, aes(Armed.Forces, Unemployed, colour = ARMUnemploy))+ geom_point()+labs(title = "Condition based plot of Y and N")
